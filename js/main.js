...
function initApp() {
    ...
    // UPDATED: This handler now creates a new, dedicated worker for analysis.
    runAnalysisBtn.on('click', function() {
        ...
        // Fetch and create a new Stockfish worker dedicated to analysis
        fetch(APP_CONFIG.STOCKFISH_URL)
            ...
            .then(text => {
                try {
                    // Create the new worker and store it in the global variable
                    ...
                    // Pass the NEW dedicated worker to the AnalysisController
