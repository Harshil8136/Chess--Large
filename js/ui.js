...
// ADDED: New element refs for time control settings
...
let showModalOnRestart = true; // Default value, will be loaded from localStorage
...
function updateClockDisplay() {
    ...
    // UPDATED: Show infinity symbol for untimed games.
    ...
    const formatTime = (timeInMs) => {
        ...
        if (timeInMs < 10000 && timeInMs > 0) { // Show tenths of a second when under 10 seconds
